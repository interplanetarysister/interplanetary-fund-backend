...
const REAL_PLATFORMS = [
  ...
  { platform: "kofi", kind: "crowdfunding", displayName: "Interplanetary Fund – Ko-fi (pending)", campaignId: "6a6d189083f8df0b86af5491", externalTotal: 250, externalDonorCount: 0, status: "draft", automationMode: "manual" },
  ...
  { platform: "spotfund", kind: "crowdfunding", displayName: "Interplanetary Fund – Spotfund (pending)", campaignId: "6a6d189083f8df0b86af5491", externalTotal: 80, externalDonorCount: 0, status: "draft", automationMode: "ask" },
  { platform: "fundrazr", kind: "crowdfunding", displayName: "Interplanetary Fund – FundRazr (pending)", campaignId: "6a6d189083f8df0b86af5491", externalTotal: 0, externalDonorCount: 0, status: "draft", automationMode: "ask" },
  { platform: "indiegogo", kind: "crowdfunding", displayName: "Interplanetary Fund – Indiegogo (pending)", campaignId: "6a6d189083f8df0b86af5491", externalTotal: 0, externalDonorCount: 0, status: "draft", automationMode: "ask" },
  { platform: "givesendgo", kind: "crowdfunding", displayName: "Interplanetary Fund – GiveSendGo (pending)", campaignId: "6a6d189083f8df0b86af5491", externalTotal: 0, externalDonorCount: 0, status: "draft", automationMode: "auto" },
